function [Y,numIter,tElapsed,finalResidual]=Symnmfrule_Esraa(X,k,option)
% Orthogonal-NMF based on NNLS: X=AA', s.t.  A>0.
% Definition:
%     [A,S,Y,numIter,tElapsed,finalResidual]=Symnmfrule_Esraa(X,k)
%     [A,S,Y,numIter,tElapsed,finalResidual]=Symnmfrule_Esraa(X,k,option)
...
% References:
%  [1]NF-CCE 
%     symmetric nonnegative matrix factorizations for clustering. 
%%%%
